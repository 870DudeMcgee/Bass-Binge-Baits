...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <section class="product-hero">
          <div class="product-hero-left">
            <div class="product-gallery" data-gallery>
              <div class="product-gallery-main">
                <div class="product-gallery-track"></div>
                <button class="product-gallery-arrow prev" type="button" aria-label="Previous image">
                  <svg aria-hidden="true" viewBox="0 0 24 24"><path d="m15 18-6-6 6-6" /></svg>
                </button>
                <button class="product-gallery-arrow next" type="button" aria-label="Next image">
          ...
          <div class="product-hero-right">
            <div class="product-config" data-product-key="${escapeHtml(product.handle)}"></div>
            <div class="product-config-selector">
              <label class="config-label">Color:</label>
              <div class="variant-swatches"></div>
              <p class="selected-color-name" data-color-name></p>
            </div>
            ...
            <div class="product-config-selector" data-weight-group>
              <label class="config-label">Weight:</label>
              <div class="weight-options"></div>
            </div>
            <div class="product-config-selector" data-rattle-group>
              <label class="config-label">Rattle:</label>
              <div class="weight-options"></div>
            </div>
    ...
    <script src="/assets/js/limited-drop-gallery.js?v=20260727-product-media" defer></script>
    <script src="/assets/js/product-page.js?v=20260727-product-media" defer></script>
  </body>
</html>`;
}
