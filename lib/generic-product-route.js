...
<html lang="en">
  ...
  <body data-generic-product>
      ...
      <div class="container">
        <section class="product-hero">
          <div class="product-hero-left">
            <div class="product-gallery" data-gallery aria-label="${escapeHtml(product.title)} image gallery">
    ...
    <script src="/assets/js/generic-product-page.js?v=20260728-color-only" defer></script>
  </body>
</html>`;
}
