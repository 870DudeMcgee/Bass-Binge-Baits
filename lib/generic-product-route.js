...
function schemaVariantProperties(variant) {
  return (variant && Array.isArray(variant.selectedOptions) ? variant.selectedOptions : [])
    .reduce((properties, option) => {
      ...
      if (name === 'color' || name === 'colour') properties.color = value;
      if (name === 'size' || name === 'weight') properties.size = value;
      if (name === 'material') properties.material = value;
      if (name === 'pattern') properties.pattern = value;
      return properties;
    }, {});
}
...
function schemaVariesBy(product) {
  const properties = (product && Array.isArray(product.options) ? product.options : [])
    ...
    .map((name) => {
      if (name === 'color' || name === 'colour') return 'color';
      if (name === 'size' || name === 'weight') return 'size';
    ...
    return {
      ...
      hasVariant: variants.map((variant) => {
        ...
        const item = {
          ...
          ...schemaVariantProperties(variant)
        };
